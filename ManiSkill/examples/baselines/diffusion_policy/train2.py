...
if __name__ == "__main__":
    ...
    env_kwargs = dict(control_mode=args.control_mode, reward_mode="sparse", obs_mode="state", 
                ...
                cubeA_halfsize=0.02, cubeB_halfsize=0.02)
    ...
    env_kwargs_ood_pos = dict(control_mode=args.control_mode, reward_mode="sparse", obs_mode="state",
                render_mode="rgb_array", human_render_camera_configs=dict(shader_pack="default"),
                cubeA_color=[0, 0, 1, 1], xy_range=0.00, offset=[0.1, -0.4])
    ...
    ## to specify
    env_kwargs_ood_obstacles = dict(control_mode=args.control_mode, reward_mode="sparse", obs_mode="state",
                render_mode="rgb_array", human_render_camera_configs=dict(shader_pack="default"), 
                cubeA_halfsize=0.02, cubeB_halfsize=0.04, cubeA_color=[1,1,1,1], offset=[0.2,0.0])
    ...
    env_ood_obstacles = make_eval_envs(args.env_id, args.num_eval_envs, args.sim_backend, env_kwargs_ood_obstacles, other_kwargs,  video_dir=f'runs/{run_name}/videos_ood_obstacles' if args.capture_video else None)
