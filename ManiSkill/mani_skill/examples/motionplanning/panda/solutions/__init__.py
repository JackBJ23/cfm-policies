...
# added:
from .pick_place import solve as solvePlaceCubeOnPlate
from .stack_w_obstacle import solve as solveStackwithObstacle
from .stackwithobstacle import solve as solveStackWObstacle
