...
from mani_skill.examples.motionplanning.panda.solutions import solveStackWObstacle, solveStackwithObstacle, solvePlaceCubeOnPlate, solvePushCube, solvePickCube, solveStackCube, solvePegInsertionSide, solvePlugCharger, solvePullCubeTool, solveLiftPegUpright, solvePullCube, solveDrawTriangle, solveDrawSVG, solvePlaceSphere, solveStackPyramid
MP_SOLUTIONS = {
    ...
    "PlaceCubeOnPlate-v1": solvePlaceCubeOnPlate,
    "StackWithObstacle-v1": solveStackWObstacle,
}
def parse_args(args=None):
    ...
    parser.add_argument("--add-obstacle", action="store_true")
...
def main(args):
    if args.num_procs > 1 and args.num_procs < args.num_traj:
        ...
        for h5_path in res:
            ...
            os.remove(json_path)
        ## print(f"Merged trajectory files saved at {output_path}")
    else:
        _main(args)
