...
modelname="CFM-fms100-5_0500-40-bs-512-5"
agent_type="CFM"
python evaluations_cfm_ood.py \
...
modelname="CFMpi0-fms100-5_0500-40-bs-512-5"
agent_type="CFM"
python evaluations_cfm_ood.py \
    --env-id StackWithObstacle-v1 \
    --checkpoint "runs/${modelname}/checkpoints/best_eval_success_at_end.pt" \
...
modelname="RF-fms100-5_0500-40-bs-512-5"
agent_type="RF"
python evaluations_cfm_ood.py \
    --env-id StackWithObstacle-v1 \
    --checkpoint "runs/${modelname}/checkpoints/best_eval_success_at_end.pt" \
...
modelname="RFpi0-fms100-5_0500-40-bs-512-5"
agent_type="RF"
python evaluations_cfm_ood.py \
    --env-id StackWithObstacle-v1 \
    --checkpoint "runs/${modelname}/checkpoints/best_eval_success_at_end.pt" \
...
modelname="dp-5_0500-5_0501-40-bs-512-115"
agent_type="DP"
python evaluations_cfm_ood.py \
    --env-id StackWithObstacle-v1 \
    --checkpoint "runs/${modelname}/checkpoints/best_eval_success_at_end.pt" \
