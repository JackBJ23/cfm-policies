...
# demos1=30
# for OOD obstacle:
ds_name1="4_0041" # without obstacle
ds_name2="4_0051" # with obstacle
demos1=200
...
for demos2 in 200; do
  echo "=== Running demos2=${demos2} ==="
  srun python train3.py \
    ...
    --exp-name dp-${ds_name1}-${ds_name2}-${demos2}-bs-${batch_size}-${train_seed} \
    --eval_freq 5000 \
